...
public class RestTemplateExamples {
    ...
    public void createCustomer() throws Exception {
        ...
        postMap.put("firstname", "Jimmy");
        postMap.put("lastname", "McGill");
    ...
    public void updateCustomer() throws Exception {
        ...
        Map<String, Object> postMap = new HashMap<>();
        postMap.put("firstname", "Jesse");
        postMap.put("lastname", "Pinkman");
        ...
        postMap.put("firstname", "Capn");
        postMap.put("lastname", "Cook");
